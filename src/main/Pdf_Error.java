...
public class Pdf_Error {
	private static final Logger LOGGER = LoggerFactory.getLogger(Pdf_Error.class);
...
//		java.util.Date fecha = new Date();
		...
		File archivos = new File("/home/dortiz/Documentos/consulta-sunat/PDF-ERROR/bk"+fecha+"-MS.txt");
		File archivos2 = new File("/home/dortiz/Documentos/consulta-sunat/PDF-ERROR/bk"+fecha+".txt");
		File archivos3 = new File("/home/dortiz/Documentos/consulta-sunat/PDF-ERROR/bk"+fecha+"-MS-UUID.txt");
		File archivos4 = new File("/home/dortiz/Documentos/consulta-sunat/PDF-ERROR/bk"+fecha+"-UUID.txt");
...
//                  String accessKey = ((Document) ((Document) document.get("Interfaces")).get("REST")).getString("AccessKey");
			...
			if(DescriptionError.contains("MS-PDF")){
				...
				doc.add(UUID+"\t"+ ID+"\t"+ "pdf"+"\t"+ DocumentType+"\t"+ PartyIdentification);
				lista2.add(PartyIdentification+","+DocumentType+","+ID+","+UUID+","+DescriptionError);
			}
//			if(count>0){
//				if(count==0){
//					respuesta=ticket;
...
//				}
				if(!tipoD.equals("zip")){
					String rutaInicial="/home/dortiz/Documentos/consulta-sunat/PDF-ERROR/PDF-VALIDO/";
