...
public class UpdateLinkPDF {
	private static final Logger LOGGER = LoggerFactory.getLogger(UpdateLinkPDF.class);
...
//		 pe.com.rackspace.storage.test
		...
		identifiers.add("726c2628-b25d-42af-860a-05a1d09211e4");
//		identifiers.add("17dd8f07-3728-4192-b16e-d8c1307e9745");
//		identifiers.add("33024ee3-8239-407b-acc2-b9eb7c224cf4");
//		identifiers.add("a2b6507b-476b-48fa-9612-9d52b1cd1fe3");
...
//		Bson fMigration = Filters.and(Filters.exists("Storage.PDF", true));
		Bson fMigration = Filters.and(Filters.exists("Storage.XML", true));
